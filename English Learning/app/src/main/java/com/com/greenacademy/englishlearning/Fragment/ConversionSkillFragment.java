...
public class ConversionSkillFragment extends Fragment implements GetterAudio {
    final int PLAY = 1;
    final int STOP = -1;
    final int PAUSE = 0;
...
//                    System.out.println("------------" + currentPosition + "----------------");
    ...
    public void getAudio(AudioLesson audioLesson) {
        ...
        prepareMediaPlayerAsyncTask.setConversionSkillFragment(this);
    ...
    public void setFunctionForButton() {
        ...
        recordingAdapter.setConversionSkillFragment(this);

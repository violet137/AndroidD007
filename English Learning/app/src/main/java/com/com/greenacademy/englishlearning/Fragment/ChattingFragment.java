...
import com.com.greenacademy.englishlearning.AsyncTask.GetPracticeSkillAsyncTask;
...
public class ChattingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        GetPracticeSkillAsyncTask getPracticeSkillAsyncTask = new GetPracticeSkillAsyncTask();
        getPracticeSkillAsyncTask.setChattingFragment(this);
        getPracticeSkillAsyncTask.execute();
    ...
    private void getMessageList() {
        SimpleDateFormat sdf = new SimpleDateFormat("hh:mm");
        UserMessage message = new UserMessage(arrUserMess.get(index), null, sdf.format(new Date()));
        list.add(message);
        index++;
        mMessageAdapter.notifyDataSetChanged();
        mMessageRecycler.setAdapter(mMessageAdapter);
    ...
    private void hintWord() {
        String[] result = arrUserMess.get(index).split(" ");
        ...
        if (countChooseWord == 0) {
            ...
            if (arrUserMess.get(index).contains(stranswer.trim())) {

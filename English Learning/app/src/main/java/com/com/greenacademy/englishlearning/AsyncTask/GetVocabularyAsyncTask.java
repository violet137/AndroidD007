...
public class GetVocabularyAsyncTask extends AsyncTask<Integer, Void, Vocabulary> {
    ...
    protected Vocabulary doInBackground(Integer... integers) {
        try {
            ...
            String urlServer = "http://tamod.vn:8081/api/LessionDetail/VocabularyById?idLession=" + idLesson;
                ...
                if (!responseJson.isEmpty()) {
                    ...
                    if (status == 1) {
                        ...
                        if (vocabularyTranfers.length() > 0) {
                            ...
                            String urlVideo = vocaBig.getString("VideoUrl");
